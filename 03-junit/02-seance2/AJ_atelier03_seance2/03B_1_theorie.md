...
Comme vu en séance 1, un assistant IA peut aider à écrire des tests, mais chaque test généré doit être relu, exécuté, et vérifié en cassant volontairement le code testé (le test doit alors passer au rouge). Sur cette séance, deux pièges supplémentaires à surveiller :

...
public class Prix {
    ...
    /**
     * Crée un prix assorti d'une promotion.
     *
    ...
    /**
     * Renvoie le type de promotion appliquée.
     *
     * @return le type de promotion, ou null si le prix n'en porte aucune
     */
    ...
    /**
     * Renvoie la valeur de la promotion, à interpréter selon son type.
     *
     * @return un montant en euros pour PUB, un pourcentage pour SOLDE et DESTOCKAGE, 0 en
     ...
     *
     * @param quantiteMin  la quantité à partir de laquelle ce prix unitaire s'applique
    ...
    /**
     * Renvoie la promotion éventuelle, puis un palier de prix par ligne.
     *
     * @return la représentation textuelle du prix
     */
    @Override
    public String toString() {
        String detail = "";
        if (typePromo != null) {
            detail += "Promo : " + typePromo + " - " + valeurPromo + "\n";
        }

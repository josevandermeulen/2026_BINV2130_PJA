...
// Question 3 : la classe Plat — déclaration et énumérés internes Difficulte et Cout
/**
...
public class Plat {
    ...
    // Question 3 : attributs, collections et constructeur
    ...
    // Question 3 : gestion des instructions (insérer, ajouter, remplacer, supprimer) et consultation non modifiable
    /**
    ...
    // Question 7 : ensemble trié des ingrédients via un Comparator anonyme
    /**
    ...
    // Question 6 : gestion des ingrédients (ajouter x2, modifier, supprimer, trouver)
    /**
    ...
    // Question 4 : toString de Plat (à ce stade, sans la partie ingrédients — traitée à la Question 6)
    /**

...
/**
 * Programme de démonstration : fait courir des compteurs via CompletableFuture et affiche leur ordre d'arrivée.
 */
public class TestCompteurEtPositionCompletableFuture {
    ...
    public static void main(String[] args) {
        ...
        Arrays.asList(compteurs).forEach(compteur ->
                System.out.println("Compteur : " + compteur.getNom()
                        + " - Position : " + compteur.countAndGetPosition()));

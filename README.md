...
- **Évaluation continue (10 %)** : les QCM hebdomadaires sur mooVin, sans points négatifs, plus un QCM remis sous la forme d'un fichier Markdown complété, une remise de code en archive zip (voir ci-dessous) et un court QCM sur la consultation hors connexion des cheat sheets. La note est calculée sur les **12 meilleurs résultats des 15 évaluations** ; une évaluation non réalisée est cotée 0. En vue de la seconde session, les 15 évaluations sont **rouvertes avant le début du deuxième quadrimestre et le restent jusqu'au jour de l'examen de septembre** : vous pouvez faire celles qui vous manquent et refaire les autres. Pour chacune, c'est votre meilleur résultat qui compte — la note ne peut que monter.

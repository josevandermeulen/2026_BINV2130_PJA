...
La lecture est identique à celle vue en séance 1 : `isAnnotationPresent` pour tester la présence, `getAnnotation(X.class).valeur()` pour lire un élément (voir la section « Annotations à élément » de [`11A_1_theorie.md`](../../01-seance1/AJ_atelier11_seance1/11A_1_theorie.md)).

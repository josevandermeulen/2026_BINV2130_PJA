...
public class Actor {
    ...
    /**
     * Compare deux acteurs sur leur nom et leur nationalité.
     *
     * @param o l'objet à comparer à cet acteur
     * @return true si o est un acteur de même nom et de même nationalité
     */
    @Override
     ...
     * equals(Object).
     *
     * @return le code de hachage de l'acteur
     */
    @Override
    public int hashCode() {

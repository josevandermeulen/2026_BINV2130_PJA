...
/**
 * Programme de démonstration : constitue un catalogue de produits, leur donne des prix par palier
 * et par date, puis affiche les prix obtenus selon la quantité et la date d'achat.
 */
public class Main {

...
Veuillez créer un nouveau Projet Maven au sein d'IntelliJ nommé `AJ_atelier06_seance2` (voir le [tutoriel Maven](../../../05-mocks/02-seance2/AJ_atelier05_seance2/05B_3_tutoriel-maven.md) si besoin). Récupérez les classes fournies dans `AJ_atelier06_seance2/src/main/java/` (packages `domaine`, `main`) et les tests fournis dans `AJ_atelier06_seance2/src/test/java/` en conservant l'arborescence. Ajoutez la dépendance JUnit 5 à votre `pom.xml`.
...
*Passez à la [théorie suivante](../../../07-programmation-fonctionnelle/01-seance1/AJ_atelier07_seance1/07A_1_theorie.md).*

...
Rappel de la séance 1 : si un getter renvoie directement la collection interne, le code extérieur peut la modifier sans passer par les méthodes de la classe et l'encapsulation est cassée.

...
1. [`../../../09-threads-completablefuture/02-seance2/01-ressources/09B_1_theorie.md`](../../../09-threads-completablefuture/02-seance2/01-ressources/09B_1_theorie.md) pour `CompletableFuture` ;
2. [`../../../08-lecture-fichiers/02-seance2/01-ressources/08B_1_theorie.md`](../../../08-lecture-fichiers/02-seance2/01-ressources/08B_1_theorie.md) pour HyperLogLog (registres, zéros de tête, formule d'estimation).

...
Dans la séance 1, nous avons lancé des traitements asynchrones en manipulant directement des `Thread`. Cette approche de bas niveau montre vite ses limites :

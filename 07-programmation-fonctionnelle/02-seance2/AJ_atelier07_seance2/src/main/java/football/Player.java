...
public class Player {
    ...
    /**
     * Compare deux joueurs sur leur nom et leur nationalité.
     *
     * @param o l'objet à comparer à ce joueur
     * @return true si o est un joueur de même nom et de même nationalité
     */
    @Override

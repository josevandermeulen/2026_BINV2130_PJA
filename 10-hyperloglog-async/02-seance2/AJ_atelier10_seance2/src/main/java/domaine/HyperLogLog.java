...
public class HyperLogLog {
     ...
     *
     * @param autre l'estimateur à fusionner, de même taille que celui-ci
     * @throws IllegalArgumentException si l'autre estimateur est null ou n'a pas le même nombre de
     *                                  registres
     */
